...
class RestaurantServiceTest {
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        restaurant = service.addRestaurant("Tester","Chennai",openingTime,closingTime);
        Restaurant expectedRestaurant = service.findRestaurantByName("Tester");
        assertEquals(restaurant, expectedRestaurant);
    }

    @Test
    public void searching_for_non_existing_restaurant_should_throw_exception() {
        restaurant = service.addRestaurant("Tester 2","Chennai",openingTime,closingTime);
