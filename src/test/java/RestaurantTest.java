...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime currentMockedTime = LocalTime.parse("13:00:00");
    ...
    // Adding feature using ADD
    @Test
    public void adding_no_items_to_order_display_total_value_as_0() throws itemNotFoundException {
        restaurant =new Restaurant("Cafe coffee","Toronto",openingTime,closingTime);
        restaurant.addToMenu("ItemA",110);
        restaurant.addToMenu("ItemB", 220);
    ...
    public void adding_items_to_order_display_total_value_as_their_individual_price_summation() throws itemNotFoundException {
        restaurant =new Restaurant("vogue cafe","Kerala",openingTime,closingTime);
        restaurant.addToMenu("ItemA",110);
        restaurant.addToMenu("ItemB", 220);
        restaurant.addToMenu("ItemC", 330);
